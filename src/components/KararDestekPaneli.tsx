    ...
    <div className="ds-card">
      <div className="border-b px-5 py-4" style={{ borderColor: brand.border }}>
        <div className="flex items-center gap-2">
          <span className="ds-chip" style={{ background: "#EEF4FF", color: "#2350B8", border: "1px solid #2350B8" }}>Operasyonel</span>
          <div className="field-label">Karar Destek & Optimizasyon</div>
        </div>
        ...
        <p className="mt-1 max-w-2xl text-xs" style={{ color: brand.inkSoft }}>
          ...
          Aşağıdan bir hedef aralık girin — gereken en az filo ve uygunluğu anında hesaplanır. Maliyet ekseninde en iyi filo için aşağıdaki <b>Ekonomik</b> panele bakın.
        </p>
      </div>
