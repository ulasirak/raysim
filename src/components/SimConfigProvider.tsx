...
// türkray — paylaşılan PROJE DURUMU context'i.
...
import { konyaSeed, type DurakArasiRing } from "@/lib/anaray/ring";

const CFG_ANAHTAR = "turkray_simconfig_v1";
const RING_ANAHTAR = "turkray_rings_v1";
const META_ANAHTAR = "turkray_projemeta_v1";
