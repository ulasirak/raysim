...
/** PDF rapor stil bloğu (<style>…</style>) — rapor.ts'ten ayrıldı (dosya boyutu). Yalnız INK/RED/GOLD interpolasyonlu; içerik birebir taşındı. */
export function raporStil(INK: string, RED: string, GOLD: string): string {
  return `<style>
